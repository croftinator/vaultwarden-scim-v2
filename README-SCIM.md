# Vaultwarden + SCIM v2 - fork guide

This file holds everything specific to this fork. Upstream's own README is left
untouched in [README.md](README.md) so their edits keep merging cleanly - see
